function [handles, p, err] = microstrip_plot_static_er(handles,x_start,x_stop,num)

% N Michael Sheridan
% September 2018
% Plots one or more microstrip static effective dielectric constants
...
title('Static Equivalent Dielectric Constant');
ylabel('Equivalent Dielectric Constant');

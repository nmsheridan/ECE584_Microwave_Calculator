...
if(isnan(f))
    ...
    if(isnan(bypass))
        ...
        F3ans = sprintf('TM1 Mode Frequency: %.4f [MHz]',(fT3/(1e6)));
        F2ans = sprintf('TM2 Mode Frequency: %.4f [MHz]',(fT2/(1e6)));
        F4ans = sprintf('SW1 Mode Frequency: %.4f [MHz]',(fT4/(1e6)));
        F1ans = sprintf('SW2 Mode Frequency: %.4f [MHz]',(fT1/(1e6)));

...
% Last Modified by GUIDE v2.5 15-Sep-2018 20:43:59
...
prompt = {'Dielectric Constant (er)','Wire Diameter (d)','Wire Distance (D)'};
...
prompt = {'Dielectric Constant (er)','Inner Diameter (d)','Outter Diameter (D)'};
...
prompt = {'Dielectric Constant (er)','Embedded Conductor Width (w)',...
    'Ground Plane Distance (b)'};
...
prompt = {'Dielectric Constant (er)','Strip Width (w)',...
    'Conductor Distance (b)'};
...
prompt = {'Dielectric Constant (er)','Characteristic Impedence (Zo)',...
    'Embedded Conductor Width (w)','Ground Plane Distance (b)'};
...
prompt = {'Dielectric Constant (er)','Characteristic Impedence (Zo)',...
    'Conductor Width (w)','Ground Plane Distance (b)'};
